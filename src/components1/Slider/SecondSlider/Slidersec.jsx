    ...
    <div style={{marginTop:"3rem"}} className={styles.container}>
      <Slide >
         <div style={{
          ...
          <div>
          <Link to='/products/subscribe'>
            <img style={{borderRadius:"3rem",border:"3px solid #e5b95f"}} src="https://cdn.shopify.com/s/files/1/0052/7551/6995/files/What_s-In-The-Bag-2_9bedf574-c534-4874-91c5-e28b5c916023_2048x.png?v=1659500490" alt="" />
          ...
          <div>
          <Link to='/products/subscribe'>
            <img style={{borderRadius:"3rem",border:"3px solid #e5b95f"}} src="https://cdn.shopify.com/s/files/1/0052/7551/6995/files/What_s-In-The-Bag-3_c51024ea-e8b5-49e6-a60f-7ebadf441433_2048x.png?v=1659674566" alt="" />
          <Text w='18rem' fontSize='1.04rem'>SUGAR POP VITAMIN C & TEA TREE FACEWASH</Text>
         </Link>
          </div>
          <div>
          <Link to='/products/subscribe'>
            <img style={{borderRadius:"3rem",border:"3px solid #e5b95f"}} src="https://cdn.shopify.com/s/files/1/0052/7551/6995/files/What_s-In-The-Bag-5_6626eab8-e174-491f-9b2e-ec771773381a_2048x.png?v=1659887286" alt="" />
